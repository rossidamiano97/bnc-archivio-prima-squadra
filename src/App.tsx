...
function Seasons({
  ...
  return (
    <>
      <SectionTitle>Stagioni</SectionTitle>
...
function PlayerForm() {
  ...
  async function handleSubmit(
    ...
    window.alert("Giocatore salvato");
  }
